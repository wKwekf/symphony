defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Agent do
    ...
    embedded_schema do
      ...
      field(:max_continuation_retries, :integer, default: 0)
      field(:max_total_tokens_per_issue, :integer, default: 0)
      field(:max_runtime_ms_per_issue, :integer, default: 0)
    ...
    def changeset(schema, attrs) do
      ...
      |> validate_number(:max_continuation_retries, greater_than_or_equal_to: 0)
      |> validate_number(:max_total_tokens_per_issue, greater_than_or_equal_to: 0)
      |> validate_number(:max_runtime_ms_per_issue, greater_than_or_equal_to: 0)
